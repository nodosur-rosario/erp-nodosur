...
CREATE TABLE realtime.messages_2026_05_25 (
  ...
  inserted_at timestamp without time zone NOT NULL DEFAULT now(),
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  CONSTRAINT messages_2026_05_25_pkey PRIMARY KEY (id, inserted_at)
);
CREATE TABLE realtime.messages_2026_05_26 (
  ...
  inserted_at timestamp without time zone NOT NULL DEFAULT now(),
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  CONSTRAINT messages_2026_05_26_pkey PRIMARY KEY (id, inserted_at)
);
CREATE TABLE realtime.messages_2026_05_27 (
  ...
  inserted_at timestamp without time zone NOT NULL DEFAULT now(),
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  CONSTRAINT messages_2026_05_27_pkey PRIMARY KEY (id, inserted_at)
);
CREATE TABLE realtime.messages_2026_05_28 (
  ...
  inserted_at timestamp without time zone NOT NULL DEFAULT now(),
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  CONSTRAINT messages_2026_05_28_pkey PRIMARY KEY (id, inserted_at)
);
CREATE TABLE realtime.messages_2026_05_29 (
  ...
  inserted_at timestamp without time zone NOT NULL DEFAULT now(),
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  CONSTRAINT messages_2026_05_29_pkey PRIMARY KEY (id, inserted_at)
);
